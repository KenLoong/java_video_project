        ...
        <div class="modal-body">
          <div class="login-div" v-show="MODAL_STATUS === STATUS_LOGIN">
            ...
            <div class="form-group">
              <input v-model="member.mobile" class="form-control" placeholder="邮箱">
            </div>
            <div class="form-group">
          ...
          <div class="register-div" v-show="MODAL_STATUS === STATUS_REGISTER">
            ...
            <div class="form-group">
              ...
              <span v-show="registerMobileValidate === false" class="text-danger">邮箱格式不正确</span>
            </div>
            <div class="form-group">
              <div class="input-group">
                <input v-on:blur="onRegisterMobileCodeBlur()"
                       ...
                       placeholder="邮箱验证码" v-model="memberRegister.smsCode">
              ...
              <span v-show="registerMobileCodeValidate === false" class="text-danger">请输入6位验证码</span>
            </div>
            <div class="form-group">
          ...
          <div class="forget-div" v-show="MODAL_STATUS === STATUS_FORGET">
            ...
            <div class="form-group">
              <input v-on:blur="onForgetMobileBlur()"
                     ...
                     class="form-control" placeholder="邮箱号">
              <span v-show="forgetMobileValidate === false" class="text-danger">邮箱必须已注册</span>
            </div>
            <div class="form-group">
              <div class="input-group">
                <input v-on:blur="onForgetMobileCodeBlur()"
                       ...
                       placeholder="邮箱验证码" v-model="memberForget.smsCode">
                <div class="input-group-append">
              ...
              <span v-show="forgetMobileCodeValidate === false" class="text-danger">请输入6位验证码</span>
            </div>
            <div class="form-group">
              <!--:blur就是鼠标失去焦点时触发的事件-->
  ...
  export default {
    ...
    methods: {
      ...
      onRegisterMobileBlur () {
        ...
        //改为验证邮箱
        _this.registerMobileValidate = Pattern.validateEmail(_this.memberRegister.mobile);
