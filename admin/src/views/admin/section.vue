          ...
          <div class="modal-body">
            <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <p class="form-control-static">{{course.name}}</p></div>
              </div>
              <div class="form-group">
                  ...
                  <div v-show="section.video" class="row">
                    <div class="col-md-9">
                      <player v-bind:player-id="'form-player-div'"
                              ref="player"></player>
                      <video v-bind:src="section.video" id="video" controls="controls" class="hidden"/>
                    </div>
                  </div>
                </div>
              </div>
  ...
  export default {
    ...
    methods: {
      ...
      afterUpload(resp) {
        ...
        console.log("after upload : ",video)
      ...
      getTime() {
        ...
        setTimeout(function () {
          ...
          console.log("时间是：",_this.section.time)
        }, 1000);
      },
